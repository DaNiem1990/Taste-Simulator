...
return [
     ...
     */
    'intro_text' => <<<INTRO
Dokumentacja API systemu degustacji i profesjonalnych ocen produktów.

Zasoby wymagające zalogowania dostępne są po podaniu w nagłówku HTTP <b>Authentication</b> wartości <b>"Bearer &lt;Token&gt;"</b>, gdzie &lt;Token&gt; jest zwracany przez endpoint <b>api/login</b>.

<aside>Po prawej stronie, na ciemnym tle, przedstawione są przykładowe odwołania do API w różnych językach programowania.
Można zmieniać język programowania poprzez wybranie odpowiedniej zakładki na górze okna (lub w górnym menu nawigacyjnym na urządzeniach mobilnych).</aside>
INTRO
    ,
